...
(library Library_1
	...
	(compDef "MAX9010EXT+" (originalName "MAX9010EXT+") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "VCC_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.analog.com/MAX9010/datasheet?ADICID=SYND_WW_P682800_PF-spglobal")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "MAX9010EXT+.stp")
